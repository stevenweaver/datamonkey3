...
<div class="min-h-screen bg-gray-50 p-8">
  <div class="container mx-auto">
    <h1 class="mb-2 text-3xl font-bold text-gray-900">Multi-Analysis Monitor Demo</h1>
    <p class="mb-8 text-gray-600">Demonstrates the global analysis monitor component that tracks analyses across the application.</p>
    ...
    <div class="mb-8 rounded-lg bg-white p-4 shadow-sm">
      <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p class="text-sm text-gray-600">Start multiple analyses to see the monitor in action.</p>
        </div>
    ...
    <div class="mb-8 rounded-lg border border-gray-200 bg-white p-6">
      <h2 class="mb-4 text-xl font-bold text-gray-900">About the Multi-Analysis Monitor</h2>
      
      <div class="mb-6">
        <h3 class="mb-2 text-lg font-medium">Key Features</h3>
        <ul class="ml-5 list-disc space-y-2 text-gray-600">
          <li><strong>Global Visibility:</strong> Monitor runs on the root layout, making it accessible from any page.</li>
          <li><strong>Persistent Tracking:</strong> Users can navigate between tabs without losing track of analyses.</li>
          <li><strong>Collapsible Interface:</strong> Expands when needed, collapses to minimize distraction.</li>
          <li><strong>Notification System:</strong> Alerts users when analyses complete or fail.</li>
          <li><strong>Direct Access:</strong> Links directly to analysis results when completed.</li>
        </ul>
      </div>
      ...
      <div class="mb-6">
        ...
        <ul class="ml-5 list-disc space-y-2 text-gray-600">
          <li><strong>Good Design Is Unobtrusive:</strong> The monitor stays out of the way until needed, floating in the corner.</li>
          <li><strong>Good Design Is Honest:</strong> Shows elapsed time rather than unreliable progress estimates.</li>
          <li><strong>Good Design Makes a Product Useful:</strong> Solves the real problem of losing track of analyses during navigation.</li>
          <li><strong>Good Design Is As Little Design As Possible:</strong> Minimal interface with only essential information.</li>
        </ul>
      </div>
      
      <div>
        <h3 class="mb-2 text-lg font-medium">Implementation Details</h3>
        <p class="mb-2 text-gray-600">The monitor is implemented as a standalone Svelte component that:</p>
        <ul class="ml-5 list-disc space-y-2 text-gray-600">
          <li>Subscribes to the active analyses store to track all running analyses</li>
          <li>Uses local state to track expanded/collapsed state</li>
          <li>Provides a notification system for completed analyses</li>
          <li>Calculates and displays elapsed time rather than unreliable ETAs</li>
          <li>Is positioned using fixed positioning to always be accessible</li>
        </ul>
      </div>
    </div>
    
    <!-- Component Placement Note -->
    <div class="rounded-lg border-2 border-dashed border-blue-300 bg-blue-50 p-4 text-center">
      <p class="text-blue-800">
        <strong>Note:</strong> The Multi-Analysis Monitor appears in the upper right corner of the screen. 
        Start some analyses using the controls above to see it in action.
      </p>
    </div>
  </div>
</div>

<!-- Local instance of the monitor for demo purposes -->
<div class="fixed bottom-4 left-4 z-40">
  <MultiAnalysisMonitor position="bottom-left" />
</div>