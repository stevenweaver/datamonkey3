...
export const COMPLEXITY_MULTIPLIERS = {
	...
	steps: (value) => Math.max(1, value / 10000), // 10000 is default for BGM
	burnIn: (value) => Math.max(1, value / 1000), // 1000 is default for BGM burn-in
	samples: (value) => Math.max(1, value / 100), // 100 is default for BGM samples
	maxParents: (value) => Math.max(1, value / 1), // 1 is default for BGM max parents
	minSubs: (value) => Math.max(1, value / 1), // 1 is default for BGM min subs
