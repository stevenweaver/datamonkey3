...
<div class="fel-visualization">
  ...
  {#if significantSites.length > 0}
    <div class="significant-sites mt-6">
      <h3 class="text-lg font-semibold mb-2">Significant Sites (p ≤ 0.1)</h3>
          ...
          <tbody>
            {#each significantSites as site}
              <tr class="border-t border-gray-300">
                ...
                <td class="px-4 py-2">
                  <span class="{site.selection === 'positive' ? 'text-red-600 font-semibold' : 'text-blue-600 font-semibold'}">
