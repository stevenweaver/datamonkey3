...
<div class="method-options-tab">
  <div class="mb-6">
    <label for="method-selector" class="mb-2 block text-lg font-semibold">Select Analysis Method</label>
    <select 
      id="method-selector" 
    ...
    >
      ...
      <option value="BUSTED">BUSTED (Branch-Site Unrestricted Statistical Test for Episodic Diversification)</option>
  ...
  <div class="method-options">
    ...
    {:else}
      <div class="rounded-lg bg-yellow-50 p-4 text-yellow-700">
        <p>No configuration options available for {selectedMethod}. Click "Run Analysis" to continue with default settings.</p>
        <button
