var bs=_=>{throw TypeError(_)};var tn=(_,y,D)=>y.has(_)||bs("Cannot "+D);var M=(_,y,D)=>(tn(_,y,"read from private field"),D?D.call(_):y.get(_)),le=(_,y,D)=>y.has(_)?bs("Cannot add the same private member more than once"):y instanceof WeakSet?y.add(_):y.set(_,D);/* empty css            */import{a as H,t as ae,h as _t}from"./template-Bf37FghY.js";import{ag as fe,n as g,T as pe,p as sn,Q as xs,a as rn,X as Ne,s as De,V as Ie,f as He,R as Ve,W as nn}from"./runtime-D_5eIJdB.js";import{i as de,s as At}from"./if-qkq15gDy.js";import{e as _s,i as an}from"./each-BHgmS7vF.js";import{s as Pt}from"./attributes-OnZxMmlQ.js";import{i as ln,e as ft}from"./store-DSaKCGfv.js";import{b as on}from"./input-BUIXpOkk.js";import{b as cn}from"./select-BhYEdWed.js";import{p as As}from"./props-Byy7dS6_.js";import{o as Nt}from"./index-client-DTALjsIX.js";import{T as un}from"./TreeSelector-17CIdzbm.js";import{w as Dt}from"./index-BzKHlfNo.js";import{g as fn}from"./_commonjsHelpers-CqkleIqs.js";import"./class-BhzPnwhT.js";import"./this-CWb_DT5z.js";import"./phylotree-0S6UKtol.js";import"./GardVisualization-CWXL997O.js";import"./html-CxodrJdO.js";const pn="1756242860401";var Ns;const dn=((Ns=globalThis.__sveltekit_o5k30f)==null?void 0:Ns.base)??"";var Ds;const hn=((Ds=globalThis.__sveltekit_o5k30f)==null?void 0:Ds.assets)??dn,vn="sveltekit:snapshot",mn="sveltekit:scroll";function Ps(_){const y=Dt(_);let D=!0;function c(){D=!0,y.update(A=>A)}function j(A){D=!1,y.set(A)}function r(A){let V;return y.subscribe(E=>{(V===void 0||D&&E!==V)&&A(V=E)})}return{notify:c,set:j,subscribe:r}}const Rs={v:()=>{}};function gn(){const{set:_,subscribe:y}=Dt(!1);let D;async function c(){clearTimeout(D);try{const j=await fetch(`${hn}/_app/version.json`,{headers:{pragma:"no-cache","cache-control":"no-cache"}});if(!j.ok)return!1;const A=(await j.json()).version!==pn;return A&&(_(!0),Rs.v(),clearTimeout(D)),A}catch{return!1}}return{subscribe:y,check:c}}let oe,pt;const yn=Nt.toString().includes("$$")||/function \w+\(\) \{\}/.test(Nt.toString());var We,Xe,Je,Ke,Qe,et,tt,st,Es,rt,Fs;yn?(oe={data:{},form:null,error:null,params:{},route:{id:null},state:{},status:-1,url:new URL("https://example.com")},pt={current:!1}):(oe=new(Es=class{constructor(){le(this,We,fe({}));le(this,Xe,fe(null));le(this,Je,fe(null));le(this,Ke,fe({}));le(this,Qe,fe({id:null}));le(this,et,fe({}));le(this,tt,fe(-1));le(this,st,fe(new URL("https://example.com")))}get data(){return g(M(this,We))}set data(y){pe(M(this,We),y)}get form(){return g(M(this,Xe))}set form(y){pe(M(this,Xe),y)}get error(){return g(M(this,Je))}set error(y){pe(M(this,Je),y)}get params(){return g(M(this,Ke))}set params(y){pe(M(this,Ke),y)}get route(){return g(M(this,Qe))}set route(y){pe(M(this,Qe),y)}get state(){return g(M(this,et))}set state(y){pe(M(this,et),y)}get status(){return g(M(this,tt))}set status(y){pe(M(this,tt),y)}get url(){return g(M(this,st))}set url(y){pe(M(this,st),y)}},We=new WeakMap,Xe=new WeakMap,Je=new WeakMap,Ke=new WeakMap,Qe=new WeakMap,et=new WeakMap,tt=new WeakMap,st=new WeakMap,Es),pt=new(Fs=class{constructor(){le(this,rt,fe(!1))}get current(){return g(M(this,rt))}set current(y){pe(M(this,rt),y)}},rt=new WeakMap,Fs),Rs.v=()=>pt.current=!0);new URL("sveltekit-internal://");const $n=window.fetch;window.fetch=(_,y)=>((_ instanceof Request?_.method:(y==null?void 0:y.method)||"GET")!=="GET"&&bn.delete(xn(_)),$n(_,y));const bn=new Map;function xn(_,y){return`script[data-sveltekit-fetched][data-url=${JSON.stringify(_ instanceof Request?_.url:_)}]`}function Us(_,y=JSON.parse){try{return y(sessionStorage[_])}catch{}}const js=new Set(["load","prerender","csr","ssr","trailingSlash","config"]);[...js];const _n=new Set([...js]);[..._n];Us(mn);Us(vn);const An={url:Ps({}),page:Ps({}),navigating:Dt(null),updated:gn()},Pn={get data(){return oe.data},get error(){return oe.error},get form(){return oe.form},get params(){return oe.params},get route(){return oe.route},get state(){return oe.state},get status(){return oe.status},get url(){return oe.url}};An.updated.check;const kn=Pn;var kt,ks;function wn(){return ks||(ks=1,kt=function(){function _(c,j){function r(){this.constructor=c}r.prototype=j.prototype,c.prototype=new r}function y(c,j,r,A,V,E){this.message=c,this.expected=j,this.found=r,this.offset=A,this.line=V,this.column=E,this.name="SyntaxError"}_(y,Error);function D(c){var j=arguments.length>1?arguments[1]:{},r={},A={start:Qt},V=Qt,E=function(){return ys},l=r,be="#",xe={type:"literal",value:"#",description:'"#"'},B=void 0,K={type:"any",description:"any character"},re="[",Q={type:"literal",value:"[",description:'"["'},ne="]",P={type:"literal",value:"]",description:'"]"'},$=function(e){bt(Y("ObjectPath",e,q,z))},b=function(e){bt(Y("ArrayPath",e,q,z))},C=function(e,s){return e.concat(s)},w=function(e){return[e]},L=function(e){return e},R=".",G={type:"literal",value:".",description:'"."'},T="=",O={type:"literal",value:"=",description:'"="'},Z=function(e,s){bt(Y("Assign",s,q,z,e))},nt=function(e){return e.join("")},it=function(e){return e.value},he='"""',_e={type:"literal",value:'"""',description:'"\\"\\"\\""'},F=null,Ae=function(e){return Y("String",e.join(""),q,z)},Ee='"',Re={type:"literal",value:'"',description:'"\\""'},ve="'''",Ue={type:"literal",value:"'''",description:`"'''"`},Pe="'",Fe={type:"literal",value:"'",description:`"'"`},je=function(e){return e},dt=function(e){return e},ht="\\",me={type:"literal",value:"\\",description:'"\\\\"'},ce=function(){return""},ue="e",ge={type:"literal",value:"e",description:'"e"'},ye="E",ie={type:"literal",value:"E",description:'"E"'},W=function(e,s){return Y("Float",parseFloat(e+"e"+s),q,z)},ke=function(e){return Y("Float",parseFloat(e),q,z)},Oe="+",we={type:"literal",value:"+",description:'"+"'},Me=function(e){return e.join("")},Ce="-",qe={type:"literal",value:"-",description:'"-"'},Ft=function(e){return"-"+e.join("")},Os=function(e){return Y("Integer",parseInt(e,10),q,z)},St="true",Ms={type:"literal",value:"true",description:'"true"'},qs=function(){return Y("Boolean",!0,q,z)},Tt="false",zs={type:"literal",value:"false",description:'"false"'},Ys=function(){return Y("Boolean",!1,q,z)},Ls=function(){return Y("Array",[],q,z)},Bs=function(e){return Y("Array",e?[e]:[],q,z)},Gs=function(e){return Y("Array",e,q,z)},Hs=function(e,s){return Y("Array",e.concat(s),q,z)},It=function(e){return e},Rt=",",Ut={type:"literal",value:",",description:'","'},Vs="{",Zs={type:"literal",value:"{",description:'"{"'},Ws="}",Xs={type:"literal",value:"}",description:'"}"'},Js=function(e){return Y("InlineTable",e,q,z)},jt=function(e,s){return Y("InlineTableValue",s,q,z,e)},Ks=function(e){return"."+e},Qs=function(e){return e.join("")},ze=":",Ye={type:"literal",value:":",description:'":"'},Ot=function(e){return e.join("")},Mt="T",qt={type:"literal",value:"T",description:'"T"'},er="Z",tr={type:"literal",value:"Z",description:'"Z"'},sr=function(e,s){return Y("Date",new Date(e+"T"+s+"Z"),q,z)},rr=function(e,s){return Y("Date",new Date(e+"T"+s),q,z)},nr=/^[ \t]/,ir={type:"class",value:"[ \\t]",description:"[ \\t]"},zt=`
...
`;var Sn=ae("<p>Method not found</p>"),Tn=ae('<p class="mb-4"> </p>'),In=ae("<p>No options available for this method</p>"),Rn=ae("<option> </option>"),Un=ae('<select class="w-full rounded border border-gray-300 p-2"></select>'),jn=ae('<input type="number" class="w-full rounded border border-gray-300 p-2">'),On=ae('<input type="file" class="w-full rounded border border-gray-300 p-2">'),Mn=ae('<div class="mb-4"><label class="mb-1 block text-gray-700"> </label> <!></div>'),qn=ae('<!> <!> <div class="mb-4"><button class="w-full rounded bg-blue-500 px-4 py-2 font-semibold text-white transition hover:bg-blue-600">Run Analysis</button></div>',1),zn=ae("<!> <!> <!>",1),Yn=ae('<div id="method-options" class="rounded-lg bg-white p-6 shadow-md"><h3 class="mb-4 text-xl font-semibold">Analysis Options</h3> <!> <!></div>');function Et(_,y){sn(y,!1);let D=As(y,"runMethod",8),c=As(y,"trees",24,()=>({})),j=kn.params.method,r=En.parse(Fn),A=xs(r[j]),V="nj",E=xs({});Nt(()=>{g(A)&&(g(A).options.forEach(P=>{P.default!==void 0?Ne(E,g(E)[P.name]=P.default):P.takes_value&&P.type==="number"&&Ne(E,g(E)[P.name]=P.minimum||0)}),Ne(A,g(A).options=g(A).options.filter(P=>P.type!=="branch-set"&&P.type!=="tree")))});function l(P,$){const{value:b}=P.target;Ne(E,g(E)[$]=b)}function be(P,$,b){P&&(V=P),b&&b.length&&console.log("Received parsed tags:",b)}function xe(){Ne(E,g(E).tree=c()[V]),D()(g(E))}ln();var B=Yn(),K=De(Ie(B),2);{var re=P=>{var $=Sn();H(P,$)};de(K,P=>{g(A)||P(re)})}var Q=De(K,2);{var ne=P=>{var $=zn(),b=He($);{var C=T=>{var O=Tn(),Z=Ie(O);Ve(()=>At(Z,g(A).description)),H(T,O)};de(b,T=>{g(A).description&&T(C)})}var w=De(b,2);{var L=T=>{var O=In();H(T,O)};de(w,T=>{g(A).options.length===0&&T(L)})}var R=De(w,2);{var G=T=>{var O=qn(),Z=He(O);un(Z,{get trees(){return c()},onChange:be});var nt=De(Z,2);_s(nt,1,()=>g(A).options,_e=>_e.name,(_e,F)=>{var Ae=Mn(),Ee=Ie(Ae),Re=Ie(Ee),ve=De(Ee,2);{var Ue=Pe=>{var Fe=_t(),je=He(Fe);{var dt=me=>{var ce=Un();Ve(()=>{g(E),nn(()=>{g(F)})}),_s(ce,5,()=>g(F).choices?g(F).choices:[{value:g(F).default,description:g(F).default}],an,(ue,ge)=>{var ye=Rn(),ie={},W=Ie(ye);Ve(()=>{ie!==(ie=g(ge).value)&&(ye.value=(ye.__value=g(ge).value)==null?"":g(ge).value),At(W,g(ge).description)}),H(ue,ye)}),cn(ce,()=>g(E)[g(F).name],ue=>Ne(E,g(E)[g(F).name]=ue)),ft("change",ce,ue=>l(ue,g(F).name)),H(me,ce)},ht=me=>{var ce=_t(),ue=He(ce);{var ge=ie=>{var W=jn();Ve(()=>{Pt(W,"min",g(F).minimum||0),Pt(W,"max",g(F).maximum||void 0),Pt(W,"placeholder",g(F).default)}),on(W,()=>g(E)[g(F).name],ke=>Ne(E,g(E)[g(F).name]=ke)),ft("input",W,ke=>l(ke,g(F).name)),H(ie,W)},ye=ie=>{var W=_t(),ke=He(W);{var Oe=we=>{var Me=On();ft("change",Me,Ce=>l(Ce,g(F).name)),H(we,Me)};de(ke,we=>{g(F).type==="file"&&g(F).name!=="alignment"&&we(Oe)},!0)}H(ie,W)};de(ue,ie=>{g(F).type==="number"?ie(ge):ie(ye,!1)},!0)}H(me,ce)};de(je,me=>{g(F).type==="string"?me(dt):me(ht,!1)})}H(Pe,Fe)};de(ve,Pe=>{g(F).takes_value&&Pe(Ue)})}Ve(()=>At(Re,g(F).description)),H(_e,Ae)});var it=De(nt,2),he=Ie(it);ft("click",he,xe),H(T,O)};de(R,T=>{g(A).options.length>0&&T(G)})}H(P,$)};de(Q,P=>{g(A)&&P(ne)})}H(_,B),rn()}Et.__docgen={version:3,name:"FormGenerator.svelte",data:[{name:"runMethod",visibility:"public",keywords:[{name:"required",description:""}],kind:"let",type:{kind:"type",type:"any",text:"any"},static:!1,readonly:!1},{name:"trees",visibility:"public",keywords:[],kind:"let",type:{kind:"type",type:"object",text:"{}"},static:!1,readonly:!1,defaultValue:"{}"}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const pi={title:"Form Analysis/FormOptions",component:Et},Ln=_=>({Component:Et,props:_}),Ze=Ln.bind({});Ze.args={runMethod:()=>{console.log("Running Form Analysis:")}};var Ss,Ts,Is;Ze.parameters={...Ze.parameters,docs:{...(Ss=Ze.parameters)==null?void 0:Ss.docs,source:{originalSource:`args => ({
